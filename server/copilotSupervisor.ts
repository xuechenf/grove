...
export function buildFleetAgentsDoc(fleet: VM[]): string {
  return [
    ...
    '- Use list_cloud_machines for provider-neutral cloud inventory. Use the cloud metrics,',
    '  firewall, and power tools with the opaque machine ids it returns.',
    '- Grove manages existing cloud machines only. Never propose creating or terminating cloud',
    '  resources; cloud mutations always pause for explicit confirmation.',
